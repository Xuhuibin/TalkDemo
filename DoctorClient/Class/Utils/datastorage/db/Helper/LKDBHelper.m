...
-(void)search:(Class)modelClass where:(id)where orderBy:(NSString *)orderBy offset:(int)offset count:(int)count groupby:(NSString*)groupby callback:(void (^)(NSMutableArray *))block
{
    [self asyncBlock:^{
...
-(NSMutableArray *)searchBase:(Class)modelClass where:(id)where orderBy:(NSString *)orderBy offset:(int)offset count:(int)count groupby:(NSString*)groupby
{
